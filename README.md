...
# Persiapan
Untuk membuat kode php, perlu menyiapkan web server dan interpreter PHP terlebih dahulu. Web server yang kita gunakan adalah Apache2 dan interpreter PHP 8. Untuk memudahkan proses praktikum, kita gunakan aplikasi bundle web server yaitu XAMPP.

## Install XAMPP
1. Langkah pertama yaitu, Unduh XAMPP [Disini](https://www.apachefriends.org/download.html). lalu pilih versi php (saya menggunakan PHP 8). lalu klik Download.
2. Kemudian buka installer XAMPP nya, setelah itu install.
3. Secara default XAMPP itu akan disimpan dalam Local Disk (C:)

![Install XAMPP](Screenshoot/xampp_folder.png)

4. Buka XAMPP Control Panel.
5. Lalu klik Start pada Apache dan MySQL.

![XAMPP PANEL](Screenshoot/xampp_panel.png)
...
![Lab2Web](Screenshoot/index_lab2web.png)
...
![Predefine Variable](Screenshoot/latihan2.png)
...
![Form Input](Screenshoot/latihan3.png)
...
![Operator](Screenshoot/operator.png)
...
![Perulangan For](Screenshoot/perulanganfor.png)
...
![Perulangan While](Screenshoot/perulanganwhile.png)
...
![Praktikum1](Screenshoot/praktikum.png)

- Sesudah diinputkan.

![Praktikum2](Screenshoot/praktikuminput.png)
